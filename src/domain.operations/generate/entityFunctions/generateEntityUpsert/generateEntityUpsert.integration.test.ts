...
import { getShowCreateFunction } from '@src/.test.utils/getShowCreateFunction';
import { normalizeCreateFunctionDdl } from '@src/_topublish/postgres-show-create-ddl/showCreateFunction/normalizeCreateFunctionDdl';
import { uuid as uuidV4 } from '@src/deps';
...
describe('generateEntityUpsert', () => {
  ...
  describe('versioned entity', () => {
    ...
    it('should create the entity accurately', async () => {
      ...
      const { id, uuid, createdAt, effectiveAt, updatedAt } =
        await upsertUser(props);
