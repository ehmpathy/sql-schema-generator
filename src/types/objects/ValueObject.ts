...
/*
  turns out: Value Objects, from a persistance perspective, are just like Entities - except with more constraints:
...
export class ValueObject extends Entity {
  constructor(props: ValueObjectConstructorProps) {
    ...
    if (updateableProperties.length) throw new Error('value objects can not have updateable properties, by definition');
