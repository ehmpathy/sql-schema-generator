...
import { readDeclarationFile } from './readDeclarationFile'; // we ignore this line since we can't define a type declaration for a relative module
...
describe('generateSchema', () => {
  ...
  it('should read the config file', async () => {
    await generateSchema({ configPath: '__CONFIG_PATH__', targetDirPath: '__TARGET_DIR_PATH__' });
