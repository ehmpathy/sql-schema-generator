// note: in real usage, users would import from 'sql-schema-generator'
// for integration tests, jest moduleNameMapper resolves @src/ aliases
import { Event, Entity, Literal } from '@src/domain.objects';
