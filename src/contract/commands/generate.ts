...
export default class Generate extends Command {
  public static description = 'generate sql schema for immutable and mutable entities: tables, upsert method, and views';

  public static flags = {
    help: flags.help({ char: 'h' }),
    declarations: flags.string({ char: 'd', description: 'path to config file, containing entity definitions', required: true, default: 'declarations.ts' }),
    target: flags.string({ char: 't', description: 'target directory to record generated schema into', required: true, default: 'generated' }),
  };
